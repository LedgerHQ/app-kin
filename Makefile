...
APP_LOAD_PARAMS=--appFlags 0x240 --path "44'/$(BIP44_KIN_COIN_INDEX)'" --curve ed25519 $(COMMON_LOAD_PARAMS)
...
ICONNAME=blue_app_kin.gif
else
	ifeq ($(TARGET_NAME),TARGET_NANOX)
ICONNAME=nanox_app_kin.gif
	else
ICONNAME=nanos_app_kin.gif
	endif
endif
