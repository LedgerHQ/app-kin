...
int main(int argc, char *argv[]) {
    ...
    test_print_amount(1, "0.0000001 KIN");
    test_print_amount(10000000, "1 KIN");
    test_print_amount(100000000000001, "10000000.0000001 KIN");
    test_print_amount(100000001, "10.0000001 KIN");
    test_print_amount(100000001000000, "10000000.1 KIN");
